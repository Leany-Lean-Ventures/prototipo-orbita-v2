...
export const ocorrenciasList: OcorrenciaItem[] = [
  ...
  { id: "OCC-006", tipo: "Denúncia", colorTheme: "rose", titulo: "Denúncia de prática comercial irregular", entidade: "C012 (Pedro Costa)", data: "2026-07-01T08:30:00Z", tempo: "há 22d", responsavel: "Diretoria", status: "Aberto" },
  { id: "OCC-007", tipo: "Conflito", colorTheme: "red", titulo: "Sobreposição de carteira entre consultores", entidade: "C001 (Maria Santos) / C005 (Fernanda Lima)", data: "2026-06-28T14:00:00Z", tempo: "há 25d", responsavel: "Carlos Oliveira", status: "Resolvido" },
