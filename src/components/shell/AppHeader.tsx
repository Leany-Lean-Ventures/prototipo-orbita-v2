...
export function AppHeader() {
  ...
  return (
    <>
      <header className="sticky top-4 z-page-header mb-4 flex h-16 shrink-0 items-center justify-between rounded-2xl border border-white/50 bg-card/80 px-6 shadow-soft backdrop-blur-md dark:border-white/5">
